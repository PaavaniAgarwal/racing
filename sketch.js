...
function setup(){
  ...
  mainCyclist  = createSprite(70,150,5,5);
  mainCyclist.addAnimation("SahilRunning",mainRacerImg1);
  mainCyclist.addAnimation("kickRunning",mainRacerImg2);
  mainCyclist.scale=0.07;
  mainCyclist.setCollider("circle",0,0,600);
  mainCyclist.debug=false;
  //set collider for mainCyclist

  resets = createSprite(650,190,350,20);
...
function draw() {
  ...
  if(keyDown(UP_ARROW)){
    ...
    mainCyclist.changeAnimation("kickRunning",mainRacerImg2);
...
function reset(){
  ...
  gameOver.visible = false;
  redCG.destroyEach(0);
  yellowCG.destroyEach(0);
  pinkCG.destroyEach(0);
  score=0;
  path.velocityX = -5;
  distance=0;
}
